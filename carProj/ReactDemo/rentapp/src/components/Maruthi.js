...
// export default function Maruthi() {
...
//   const fetchMaruthiData = async () => {
//     try {
//       const response = await axios.get("http://localhost:8083/brands/Maruthi");
//       setArr(response.data[0].models);
//     } catch (error) {
//       console.error("Error fetching Maruthi data:", error);
//     }
//   };
...
//               <img src={el.image} className="card-img" alt="Maruthi" />
//               </div> */}
//             <div className="col-md-8">
//               <div className="card-body">
//                 <h2 className="card-text">{el.brand}</h2>
...
// const [order, setOrder] = useContext(UserContext);
 ...
 useEffect(()=>{
  axios.get("http://localhost:8083/brands/Maruthi").then((res)=>setArr(res.data)
  );
 },[]);
